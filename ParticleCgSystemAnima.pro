...
LIBS += -L/opt/opencv/lib -lopencv_ximgproc -lopencv_tracking -lopencv_video -lopencv_videoio -lomp  -lsoil
...
LIBS += -L/opt/opencv/lib -lopencv_stitching -lopencv_shape -lopencv_sfm -lopencv_rgbd -lopencv_reg -lSDL2
LIBS += -L/opt/opencv/lib -lopencv_plot -lopencv_objdetect -lopencv_ml -lopencv_imgcodecs -lboost_math_tr1
LIBS += -L/opt/opencv/lib -lvisp_mbt -lvisp_io -lvisp_ar -lvisp_blob -lvisp_detection -lvisp_gui -lglad
...
LIBS += -L/opt/openmpi/lib -lmpi -lopen-pal  -lmpi_mpifh -lopen-rte -lmca_common_verbs -lompitrace -lQGLViewer-qt5
...
LIBS += -L/opt/freeglut/lib -lGL -lGLEW -lglfw -lGLU -lglut -lGLX -lSDL2 -lglad
LIBS += -L/opt/opencv/lib -lGL -lGLEW -lglfw -lGLU -lglut -lGLX -lglm_shared
LIBS += -L/opt/opencv/lib -lvisp_core -lvisp_blob -liomp5 -lvisp_visual_features -lvisp_robot
LIBS += -L/opt/Cg/lib -lCg -lCgGL -lglfw -lglslang -lGLU -lglut -lGL -lGLX -lEGL -lHLSL -lGLEW -lOpenGL -lSDL2
LIBS += -L/opt/Cg/lib -lsfml-audio -lsfml-graphics -lsfml-network -lsfml-system -lsfml-window -lSPIRV
LIBS += -L/opt/Cg/lib -lbuffer -lftoa -lktx -lUTF -lzlib -lMathMLSolver -lOpenCOLLADABaseUtils -lSPVRemapper
LIBS += -L/opt/Cg/lib -lOpenCOLLADAFramework -lOpenCOLLADASaxFrameworkLoader -lOpenCOLLADAStreamWriter
